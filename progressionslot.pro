...
UBUNTU_TRANSLATION_DOMAIN="progressionslot.liu-xiao-guo"
...
aptest.commands = bash $$PWD/progressionslot/tests/autopilot/run
aptest.depends  = sub-progressionslot

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/progressionslot/tests/unit 
unittest.depends  = sub-progressionslot
